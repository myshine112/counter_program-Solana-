...
mod test{
    ...
    async fn test_counter_program() {
        ...
        // Create a new keypair to use as the address for out counter account
        ...
        // Send transactio with initialize instruction
        ...
        let account = banks_client
            ...
            .await
            .expect("Faiiled to get counter account");
        ...
        if let Some(account_data) = account {
            let counter: CounterAccount = CounterAccount::try_from_slice(&account_data.data)
                .expect("Failed to deserialized counter data");
